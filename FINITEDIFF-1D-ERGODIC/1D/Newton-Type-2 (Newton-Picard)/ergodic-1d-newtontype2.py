...
# --- Saved File Names ---
history_filename = f"newton-type2-history_ergodic1d_T{T}_nu{nu}.txt"
plot_snapshot_filename = f"ergodic1d_spatial_snapshots_T{T}_nu{nu}.png"
...
with open(history_filename, "w") as f:
    header = (
        f"{'='*118}\n"
        f"   ERGODIC MFG EXAMPLE (NEWTON TYPE 2: NEWTON-PICARD)\n"
        f"{'='*118}\n"
        f"Parameters:\n"
