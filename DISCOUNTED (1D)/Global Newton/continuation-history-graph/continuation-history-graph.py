...
# Hardcoded values extracted from discounted-1d-newton-history.txt
...
plt.ylabel(r'$\nu$ (Viscosity)')
plt.title('Viscosity Continuation Progress (Newton)')
...
plt.tight_layout()
plt.savefig('discounted-1d-newton-continuation-history.png')
plt.show()
